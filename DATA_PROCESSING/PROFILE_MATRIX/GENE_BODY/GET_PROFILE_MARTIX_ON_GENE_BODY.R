...
ref_gene_gr = readRDS(paste0(workdir, "DATA_PROCESSING/REF_GENOME/TxDb.Dmelanogaster.Ensembl.dm6.RDS"))
file_outmatrix = as.matrix(read.table(paste0(workdir, "DATA_PROCESSING/PROFILE_MATRIX/GENE_BODY/C27_1_trimmed_filt_sort_RPGC.outmatrix"), skip=3))
out_profmat_RDS = paste0(workdir, "DATA_PROCESSING/PROFILE_MATRIX/GENE_BODY/C27_1_trimmed_filt_sort_RPGC_profmat.RDS")
